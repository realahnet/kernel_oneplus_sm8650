...
void __always_inline __balance_callbacks(struct rq *rq)
{
	do_balance_callbacks(rq, __splice_balance_callbacks(rq, false));
}
EXPORT_SYMBOL_GPL(__balance_callbacks);

static __always_inline void balance_callbacks(struct rq *rq, struct balance_callback *head)
{
	unsigned long flags;
